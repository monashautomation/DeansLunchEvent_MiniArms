...
void setup()
{
    ...
    // Apply controller MAC
    esp_err_t macResult = esp_wifi_set_mac(WIFI_IF_STA, controllerMAC);
    ...
    // Print controller MAC
    Serial.print("Controller MAC Address: ");
    Serial.println(WiFi.macAddress());

    // Print target arm MAC
    Serial.print("Target Arm MAC: ");
    for (int i = 0; i < 6; i++) {
        if (broadcastAddress[i] < 16) Serial.print("0");
